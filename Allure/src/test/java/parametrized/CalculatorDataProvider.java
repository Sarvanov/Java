 ...
 */
@Epic("Calculator")
@Feature("Параметризированные тесты. Калькулятор")
public class CalculatorDataProvider {
    ...
    @Story("Сложение двух чисел в Calculator с DataProvider")
    @Description("Тест на сложение двух чисел с DataProvider")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Story("Вычитание двух чисел в Calculator с DataProvider")
    @Description("Тест на вычитание двух чисел с DataProvider")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Story("Умножение двух чисел в Calculator с DataProvider")
    @Description("Тест на умножение двух чисел с DataProvider")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Story("Деление двух чисел в Calculator с DataProvider")
    @Description("Тест на деление двух чисел с DataProvider")
    ...
    @Severity(SeverityLevel.CRITICAL)
    @Story("Сложение двух чисел в Calculator с DataProvider")
    @Description("Негативный тест на сложение двух чисел с DataProvider")
